...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand" style="margin-left: 30px;">
            <img src="../assets/logo2.png" style="width: 150px; height: auto;">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin-left: 30px;">
            <ul class="navbar-nav mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo $current_page === 'tb' ? 'active' : ''; ?>" href="index.php?page=tb">Data Penyakit</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo $current_page === 'tg' ? 'active' : ''; ?>" href="index.php?page=tg">Data Gejala</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo $current_page === 'ta' ? 'active' : ''; ?>" href="index.php?page=ta">Data Aturan</a>
                </li>
            </ul>
            <form class="form-inline my-2 my-lg-0 ms-auto" action="logout.php" method="POST">
